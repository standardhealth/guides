...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-TreatmentIntent-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-TreatmentIntent-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-RadiationDosePerFraction-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-RadiationDosePerFraction-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-RadiationFractionsDelivered-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-RadiationFractionsDelivered-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-TotalRadiationDoseDelivered-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/obf/StructureDefinition/obf-TotalRadiationDoseDelivered-extension': maximum cardinality of 'extension' is 1</sch:assert>
